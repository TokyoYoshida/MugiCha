...
typedef enum _TYPE {ANY, INT, DOUBLE, BOOLTYPE,STRING,CLASS} TYPE;
typedef enum _OPERATION {NONE, VALUEDATA, ADD, SUB, MUL, DIV, SEQ, PRINTDATA,
    ...
    CMP_GREATER, CMP_SMALLER, CMP_GREATEREQ, CMP_SMALLEREQ ,IF_STMT,WHILE_STMT ,DEF_CLASS } OPERATION ;
