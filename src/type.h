...
typedef enum _OPERATION {NONE, VALUEDATA, ADD, SUB, MUL, DIV, SEQ, EXPR_LIST, DEF_ARGS, PRINTDATA, DEF_VAR, SET_VAR, GET_VAR, DEF_FUNC, DEF_METHOD, CALL_FUNC, CALL_METHOD, CMP_EQ, CMP_NOTEQ,CMP_GREATER, CMP_SMALLER, CMP_GREATEREQ, CMP_SMALLEREQ ,IF_STMT,WHILE_STMT ,SET_MEMBER_VAR, SET_ARRAY_VAR, GET_MEMBER_VAR, GET_ARRAY_VAR, DEF_CLASS } OPERATION ; // if modify this place, you also must modify function `get_op_description`.
